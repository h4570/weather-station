 ...
 * Size: 24 px
 * Bpp: 1
 * Opts: --bpp 1 --size 24 --no-compress --stride 1 --align 1 --font OpenSans-Bold.ttf --symbols ąćęłńóśźżĄĆĘŁŃÓŚŹŻ°% --range 32-127 --format lvgl -o lv_font_opensans_regular_24.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xc0, 0x78, 0xf0, 0x1e, 0x7c, 0x3, 0xfe, 0x0,
    0x7e, 0x0, 0x3f, 0x7, 0x9f, 0xf1, 0xef, 0x3e,
    0xf3, 0xc7, 0xfc, 0xf0, 0x7e, 0x3e, 0x1f, 0x7,
    ...
    0x1, 0xe7, 0x9f, 0x9c, 0xe7, 0xf9, 0xfd, 0xc7,
    0x3f, 0x70, 0xe7, 0xee, 0x1c, 0xfd, 0xc3, 0x9f,
    0xb8, 0x73, 0xf7, 0x9e, 0xee, 0x7f, 0xfc, 0xe7,
    0xcf, 0x1e, 0x0, 0x1, 0xe0, 0x30, 0x1f, 0xfe,
    0x0, 0x7f, 0x0,

    /* U+0041 "A" */
    0x3, 0xe0, 0x3, 0xf0, 0x1, 0xf8, 0x0, 0xee,
    ...
    0x7f, 0x70, 0xef, 0xef, 0x39, 0xfc, 0xe7, 0x3f,
    ...
    0x3f, 0x3, 0xf0, 0x3f, 0x81, 0xf8, 0xf, 0x80,
    ...
    /* U+005E "^" */
    0xe, 0x0, 0xe0, 0xf, 0x1, 0xf0, 0x1b, 0x83,
    0x98, 0x31, 0xc7, 0xc, 0x60, 0xee, 0x6, 0xe0,
    0x70,
    ...
    0x38, 0xff, 0xef, 0xfe, 0xf9, 0xff, 0xf, 0xf0,
    ...
    0xff, 0xff, 0xff, 0xff, 0xf0, 0xf, 0x80, 0x7f,
    0xe3, 0xfe, 0xf, 0xc0,
    ...
    /* U+0067 "g" */
    0xf, 0xfc, 0xff, 0xf7, 0xde, 0x1e, 0x3c, 0x78,
    0xf1, 0xe3, 0xc7, 0xdf, 0xf, 0xf8, 0x1f, 0x80,
    0xe0, 0x3, 0xff, 0xf, 0xfe, 0x7f, 0xff, 0xc0,
    ...
    0xf7, 0xff, 0x1e, 0xf0, 0xf, 0x0, 0xf0, 0xf,
    ...
    /* U+0077 "w" */
    0xf0, 0xf0, 0xff, 0xf, 0xf, 0x71, 0xf8, 0xe7,
    0x1f, 0x9e, 0x79, 0xb9, 0xe7, 0x99, 0x9c, 0x3b,
    0x99, 0xc3, 0xb9, 0xfc, 0x3b, 0x1f, 0x81, 0xf1,
    ...
    0x0, 0x70, 0x3, 0xc0, 0x7e, 0x1, 0xf8, 0x7,
    0x80, 0x0,
    ...
    /* U+007B "{" */
    0xf, 0x1f, 0x1f, 0x1c, 0x1c, 0x1c, 0x1c, 0x1c,
    ...
    /* U+00F3 "ó" */
    0x1, 0xe0, 0x1e, 0x1, 0xc0, 0xc, 0x0, 0x0,
    0x7, 0xc0, 0xff, 0x8f, 0xfe, 0x78, 0xf7, 0x83,
    0xfc, 0x1f, 0xe0, 0xff, 0x7, 0xf8, 0x3d, 0xe3,
    0xcf, 0xfe, 0x3f, 0xe0, 0x7c, 0x0,

    /* U+0104 "Ą" */
    0x3, 0xc0, 0x7, 0xe0, 0x7, 0xe0, 0xf, 0xe0,
    0xe, 0xf0, 0xe, 0x70, 0x1e, 0x78, 0x1e, 0x78,
    0x1c, 0x38, 0x3c, 0x3c, 0x3f, 0xfc, 0x3f, 0xfc,
    0x7f, 0xfe, 0x78, 0x1e, 0x70, 0x1f, 0xf0, 0xf,
    0xf0, 0xf, 0x0, 0xe, 0x0, 0x1c, 0x0, 0x18,
    0x0, 0x18, 0x0, 0x1f, 0x0, 0xf,

    /* U+0105 "ą" */
    0x1f, 0x87, 0xfe, 0x3f, 0xf3, 0x1f, 0x0, 0xf0,
    0xf, 0x3f, 0xf7, 0xff, 0xf0, 0xff, 0x1f, 0xff,
    0xf7, 0xff, 0x3c, 0x70, 0xe, 0x1, 0xc0, 0x18,
    0x1, 0x80, 0x1f, 0x0, 0xf0,

    /* U+0106 "Ć" */
    0x0, 0xf0, 0xf, 0x0, 0xf0, 0x6, 0x0, 0x0,
    0x3, 0xf0, 0x7f, 0xe7, 0xff, 0x7c, 0x13, 0xc0,
    0x3e, 0x1, 0xe0, 0xf, 0x0, 0x78, 0x3, 0xc0,
    0x1e, 0x0, 0xf0, 0x3, 0xc0, 0x1f, 0x6, 0x7f,
    0xf1, 0xff, 0x87, 0xf0,

    /* U+0107 "ć" */
    0x3, 0xc0, 0xe0, 0x70, 0x38, 0x0, 0x7, 0xe3,
    0xfd, 0xff, 0xf8, 0x3c, 0xf, 0x3, 0xc0, 0xf0,
    0x3c, 0xf, 0x85, 0xff, 0x3f, 0xc7, 0xe0,

    /* U+0118 "Ę" */
    0xff, 0xff, 0xff, 0xff, 0xc0, 0xf0, 0x3c, 0xf,
    0x3, 0xff, 0xff, 0xff, 0xff, 0x3, 0xc0, 0xf0,
    0x3c, 0xf, 0xff, 0xff, 0xff, 0xc0, 0xe0, 0x70,
    0x18, 0x6, 0x1, 0xf0, 0x3c,

    /* U+0119 "ę" */
    0x1f, 0x83, 0xfc, 0x7f, 0xef, 0x9f, 0xf0, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xf0, 0xf, 0x80, 0x7f,
    0xe3, 0xfe, 0xf, 0xe0, 0xc, 0x1, 0x80, 0x18,
    0x1, 0x80, 0x1e, 0x0, 0xe0,

    /* U+0141 "Ł" */
    0x3c, 0x1, 0xe0, 0xf, 0x0, 0x78, 0x3, 0xc0,
    0x1e, 0x80, 0xfc, 0x7, 0xe0, 0x7e, 0x7, 0xe0,
    0x3f, 0x0, 0xf8, 0x3, 0xc0, 0x1e, 0x0, 0xff,
    0xe7, 0xff, 0x3f, 0xf8,

    /* U+0142 "ł" */
    0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x3e,
    0x3f, 0x3e, 0xfc, 0xfc, 0x7c, 0x3c, 0x3c, 0x3c,
    0x3c, 0x3c,

    /* U+0143 "Ń" */
    0x0, 0xf0, 0x3, 0xc0, 0xf, 0x0, 0x38, 0x0,
    0x0, 0x1f, 0x1, 0xfe, 0x3, 0xfe, 0x7, 0xfe,
    0xf, 0xfc, 0x1f, 0xbc, 0x3f, 0x78, 0x7e, 0x78,
    0xfc, 0x79, 0xf8, 0xf3, 0xf0, 0xf7, 0xe1, 0xef,
    0xc1, 0xff, 0x83, 0xff, 0x3, 0xfe, 0x3, 0xfc,
    0x7, 0xc0,

    /* U+0144 "ń" */
    0x3, 0xc0, 0x38, 0x7, 0x0, 0xe0, 0x0, 0xe,
    0x7c, 0xef, 0xef, 0xff, 0xf9, 0xff, 0xf, 0xf0,
    0xff, 0xf, 0xf0, 0xff, 0xf, 0xf0, 0xff, 0xf,
    0xf0, 0xff, 0xf,

    /* U+015A "Ś" */
    0x3, 0xc0, 0xe0, 0x38, 0x6, 0x0, 0x0, 0x3f,
    0x1f, 0xff, 0xfe, 0xf0, 0xde, 0x3, 0xc0, 0x7e,
    0x7, 0xe0, 0x7f, 0x3, 0xf0, 0x1f, 0x1, 0xe0,
    0x3f, 0xf, 0xff, 0xef, 0xfc, 0xfe, 0x0,

    /* U+015B "ś" */
    0x7, 0x83, 0xc0, 0xe0, 0x70, 0x0, 0xf, 0xc7,
    0xff, 0xfe, 0xf0, 0xbc, 0x7, 0xe0, 0xfe, 0xf,
    0xc0, 0xf8, 0x3f, 0xff, 0xff, 0x9f, 0xc0,

    /* U+0179 "Ź" */
    0x1, 0xe0, 0x1e, 0x0, 0xe0, 0xe, 0x0, 0x0,
    0x7f, 0xff, 0xff, 0xff, 0xff, 0x0, 0xf0, 0xf,
    0x0, 0x78, 0x7, 0x80, 0x78, 0x7, 0xc0, 0x3c,
    0x3, 0xc0, 0x3c, 0x1, 0xe0, 0x1e, 0x1, 0xff,
    0xff, 0xff, 0xff, 0xfc,

    /* U+017A "ź" */
    0x7, 0x83, 0xc0, 0xe0, 0x60, 0x0, 0x3f, 0xff,
    0xff, 0xff, 0x7, 0x81, 0xc0, 0xf0, 0x78, 0x3c,
    0xe, 0x7, 0x3, 0xff, 0xff, 0xff, 0xf0,

    /* U+017B "Ż" */
    0x7, 0x80, 0x3c, 0x1, 0xe0, 0x0, 0xf, 0xff,
    0xff, 0xff, 0xff, 0xe0, 0x1e, 0x0, 0xe0, 0xf,
    0x0, 0xf0, 0xf, 0x0, 0x78, 0x7, 0x80, 0x78,
    0x7, 0x80, 0x3c, 0x3, 0xc0, 0x3f, 0xff, 0xff,
    0xff, 0xff, 0x80,

    /* U+017C "ż" */
    0x1e, 0x7, 0x81, 0xe0, 0x0, 0x0, 0x3f, 0xff,
    0xff, 0xff, 0x7, 0x81, 0xc0, 0xf0, 0x78, 0x3c,
    0xe, 0x7, 0x3, 0xff, 0xff, 0xff, 0xf0};
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 48, .adv_w = 220, .box_w = 12, .box_h = 19, .ofs_x = 1, .ofs_y = -1},
    ...
    {.bitmap_index = 208, .adv_w = 220, .box_w = 12, .box_h = 11, .ofs_x = 1, .ofs_y = 3},
    {.bitmap_index = 225, .adv_w = 110, .box_w = 4, .box_h = 5, .ofs_x = 1, .ofs_y = -3},
    ...
    {.bitmap_index = 255, .adv_w = 220, .box_w = 12, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 281, .adv_w = 220, .box_w = 9, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 301, .adv_w = 220, .box_w = 12, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 327, .adv_w = 220, .box_w = 12, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 353, .adv_w = 220, .box_w = 13, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 381, .adv_w = 220, .box_w = 12, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 407, .adv_w = 220, .box_w = 12, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 433, .adv_w = 220, .box_w = 12, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 459, .adv_w = 220, .box_w = 12, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 485, .adv_w = 220, .box_w = 12, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 511, .adv_w = 110, .box_w = 4, .box_h = 13, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 518, .adv_w = 110, .box_w = 5, .box_h = 16, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 528, .adv_w = 220, .box_w = 12, .box_h = 13, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 548, .adv_w = 220, .box_w = 12, .box_h = 7, .ofs_x = 1, .ofs_y = 5},
    {.bitmap_index = 559, .adv_w = 220, .box_w = 12, .box_h = 13, .ofs_x = 1, .ofs_y = 2},
    ...
    {.bitmap_index = 1478, .adv_w = 220, .box_w = 12, .box_h = 11, .ofs_x = 1, .ofs_y = 6},
    {.bitmap_index = 1495, .adv_w = 158, .box_w = 10, .box_h = 1, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 1497, .adv_w = 139, .box_w = 7, .box_h = 4, .ofs_x = 1, .ofs_y = 14},
    {.bitmap_index = 1501, .adv_w = 232, .box_w = 12, .box_h = 13, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1521, .adv_w = 243, .box_w = 12, .box_h = 18, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1548, .adv_w = 197, .box_w = 10, .box_h = 13, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1565, .adv_w = 243, .box_w = 12, .box_h = 18, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1592, .adv_w = 227, .box_w = 12, .box_h = 13, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1612, .adv_w = 149, .box_w = 10, .box_h = 18, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1635, .adv_w = 217, .box_w = 14, .box_h = 19, .ofs_x = 1, .ofs_y = -6},
    {.bitmap_index = 1669, .adv_w = 252, .box_w = 12, .box_h = 18, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1696, .adv_w = 117, .box_w = 4, .box_h = 18, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1705, .adv_w = 117, .box_w = 8, .box_h = 24, .ofs_x = -2, .ofs_y = -6},
    {.bitmap_index = 1729, .adv_w = 238, .box_w = 13, .box_h = 18, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1759, .adv_w = 117, .box_w = 4, .box_h = 18, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1768, .adv_w = 377, .box_w = 20, .box_h = 13, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1801, .adv_w = 252, .box_w = 12, .box_h = 13, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1821, .adv_w = 238, .box_w = 13, .box_h = 13, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1843, .adv_w = 243, .box_w = 12, .box_h = 19, .ofs_x = 2, .ofs_y = -6},
    {.bitmap_index = 1872, .adv_w = 243, .box_w = 12, .box_h = 19, .ofs_x = 1, .ofs_y = -6},
    {.bitmap_index = 1901, .adv_w = 174, .box_w = 9, .box_h = 13, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1916, .adv_w = 191, .box_w = 10, .box_h = 13, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1933, .adv_w = 167, .box_w = 9, .box_h = 16, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1951, .adv_w = 252, .box_w = 12, .box_h = 13, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1971, .adv_w = 218, .box_w = 14, .box_h = 13, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1994, .adv_w = 329, .box_w = 20, .box_h = 13, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2027, .adv_w = 222, .box_w = 14, .box_h = 13, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2050, .adv_w = 218, .box_w = 14, .box_h = 19, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 2084, .adv_w = 187, .box_w = 10, .box_h = 13, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2101, .adv_w = 151, .box_w = 8, .box_h = 21, .ofs_x = 1, .ofs_y = -4},
    {.bitmap_index = 2122, .adv_w = 212, .box_w = 3, .box_h = 24, .ofs_x = 5, .ofs_y = -6},
    {.bitmap_index = 2131, .adv_w = 151, .box_w = 8, .box_h = 21, .ofs_x = 1, .ofs_y = -4},
    {.bitmap_index = 2152, .adv_w = 220, .box_w = 12, .box_h = 4, .ofs_x = 1, .ofs_y = 6},
    {.bitmap_index = 2158, .adv_w = 164, .box_w = 8, .box_h = 8, .ofs_x = 1, .ofs_y = 9},
    {.bitmap_index = 2166, .adv_w = 306, .box_w = 16, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2210, .adv_w = 238, .box_w = 13, .box_h = 18, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2240, .adv_w = 265, .box_w = 16, .box_h = 23, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 2286, .adv_w = 232, .box_w = 12, .box_h = 19, .ofs_x = 1, .ofs_y = -6},
    {.bitmap_index = 2315, .adv_w = 245, .box_w = 13, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2351, .adv_w = 197, .box_w = 10, .box_h = 18, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2374, .adv_w = 215, .box_w = 10, .box_h = 23, .ofs_x = 2, .ofs_y = -6},
    {.bitmap_index = 2403, .adv_w = 227, .box_w = 12, .box_h = 19, .ofs_x = 1, .ofs_y = -6},
    {.bitmap_index = 2432, .adv_w = 217, .box_w = 13, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2460, .adv_w = 117, .box_w = 8, .box_h = 18, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2478, .adv_w = 312, .box_w = 15, .box_h = 22, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2520, .adv_w = 252, .box_w = 12, .box_h = 18, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2547, .adv_w = 212, .box_w = 11, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2578, .adv_w = 191, .box_w = 10, .box_h = 18, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2601, .adv_w = 222, .box_w = 13, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2637, .adv_w = 187, .box_w = 10, .box_h = 18, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2660, .adv_w = 222, .box_w = 13, .box_h = 21, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2695, .adv_w = 187, .box_w = 10, .box_h = 18, .ofs_x = 1, .ofs_y = 0}};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_opensans_regular_24 = {
#else

...
#define BME280_HUMIDITY_DISABLE 0
#define BME280_HUMIDITY_ULTRALOWPOWER 1
#define BME280_HUMIDITY_LOWPOWER 2
#define BME280_HUMIDITY_STANDARD 3
#define BME280_HUMIDITY_HIGHRES 4
#define BME280_HUMIDITY_ULTRAHIGH 5
